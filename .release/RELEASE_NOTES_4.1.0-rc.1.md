...
The pre-RC presentation baseline passed Java 25 / Paper 26.2 verification with 134 tests, 0 failures, 0 errors, and 0 skipped tests. The RC itself must pass the same canonical build and distribution gates before publication.
